  ...
  return (
    <PageShell activeKey="philosofun">
      <OnboardingGuide
        tabKey="philosofun"
        steps={[
          "Giải trí Triết học (PhilosoFUN): Không gian thư giãn giải trí giúp tiếp thu triết học một cách tự nhiên qua các tài nguyên vui nhộn.",
          "Xem Video & Meme: Khám phá thế giới triết học Mác - Lênin thông qua các clip ngắn sinh động, truyện ngụ ngôn biện chứng và meme vui nhộn.",
          "Ghi nhớ thoải mái: Nơi củng cố bài học không áp lực, giúp bạn lấy lại cảm hứng học tập sau những giờ nghiên cứu lý thuyết căng thẳng."
        ]}
      />
      {/* Hero Section */}
                ...
                >
                  <div className="aspect-video bg-slate-100 dark:bg-[#001F28] relative overflow-hidden group">
                    ...
                    <div className="absolute inset-0 bg-black/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      <span className="h-14 w-14 rounded-full bg-primary-600 text-white flex items-center justify-center shadow-lg">
                  ...
                  <div className="p-5 flex-1 flex flex-col justify-between">
                    <div>
                      <h3 className="font-bold text-slate-900 dark:text-primary-100 text-base leading-snug line-clamp-2" title={video.title}>
                        {video.title}
                      </h3>
                      <p className="text-slate-650 dark:text-primary-250 text-xs mt-2 line-clamp-3">
                        {video.description || 'Không có mô tả chi tiết.'}
                      </p>
                    </div>
                    <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between text-2xs text-slate-450 dark:text-primary-400 font-semibold">
                      <span className="flex items-center gap-1">
                        <span className="material-symbols-outlined text-xs">calendar_month</span>
                        {new Date(video.createdAt).toLocaleDateString('vi-VN')}
                      </span>
                      <span className="text-primary-650 dark:text-primary-300 flex items-center gap-0.5">
          ...
          <div className="bg-white dark:bg-surface-dark-elevated rounded-3xl w-full max-w-4xl overflow-hidden shadow-2xl text-left flex flex-col border border-slate-200 dark:border-primary-850" onClick={(e) => e.stopPropagation()}>
            <div className="px-6 py-4 border-b border-slate-200 dark:border-primary-850 flex justify-between items-center shrink-0">
              ...
              <button
                ...
                className="text-slate-500 dark:text-primary-350 hover:text-primary-650 dark:text-primary-300 text-xl font-bold p-1"
              >
            ...
            <div className="p-6 bg-slate-50 dark:bg-[#001F28] shrink-0 border-t border-slate-250 dark:border-primary-850">
              <h4 className="text-xs uppercase tracking-wider text-slate-500 dark:text-primary-350 font-bold mb-1.5">Mô tả chi tiết & Câu hỏi định hướng:</h4>
